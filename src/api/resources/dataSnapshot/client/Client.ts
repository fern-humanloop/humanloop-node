...
export class Client {
    ...
    public async getAll(projectId: string): Promise<HumanloopApi.DataSnapshot[]> {
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, `/projects/${projectId}/data-snapshots/`),
            method: "GET",
            headers: {
    ...
    public async update(
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, `/projects/${projectId}/data-snapshots//${dataSnapshotId}`),
            method: "PATCH",
            headers: {
                Authorization: core.BearerToken.toAuthorizationHeader(await core.Supplier.get(this.options.token)),
            },
