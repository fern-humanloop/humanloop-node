...
export class Client {
    ...
    public async fineTune(
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, `/projects/${projectId}/fine-tune`),
            method: "POST",
            headers: {
    ...
    public async getFineTunedModels(projectId: string): Promise<HumanloopApi.FineTunedModelResponse[]> {
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, `/projects/${projectId}/models/fine-tuned`),
            method: "GET",
            headers: {
                Authorization: core.BearerToken.toAuthorizationHeader(await core.Supplier.get(this.options.token)),
            },
    ...
    public async updateMultiple(
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, `/projects/${projectId}/models/fine-tuned/update`),
            method: "POST",
            headers: {
                Authorization: core.BearerToken.toAuthorizationHeader(await core.Supplier.get(this.options.token)),
            },
    ...
    public async update(
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, `/projects/${projectId}/models/fine-tuned/${id}`),
            method: "PATCH",
            headers: {
                Authorization: core.BearerToken.toAuthorizationHeader(await core.Supplier.get(this.options.token)),
            },
